...
public class Reporting extends TestListenerAdapter
{
	...
	public void onStart(ITestContext testContext)
	{
		...
		htmlReporter.config().setDocumentTitle("Niki Android App(English) Automation Result "); // Tile of report
		htmlReporter.config().setReportName("Functional Test Automation For Niki Android App"); // name of the report
